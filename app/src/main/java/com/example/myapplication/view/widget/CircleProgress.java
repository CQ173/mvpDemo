...
public class CircleProgress extends View {
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        mUpperColors[0] = typedArray.getInt(R.styleable.CircleProgress_upperColor1, Color.parseColor("#ECC980"));
        mUpperColors[1] = typedArray.getInt(R.styleable.CircleProgress_upperColor2, Color.parseColor("#ECC980"));
        mUpperColors[2] = typedArray.getInt(R.styleable.CircleProgress_upperColor2, Color.parseColor("#DCB273"));
        mUpperColors[3] = typedArray.getInt(R.styleable.CircleProgress_upperColor3, Color.parseColor("#D9AD6F"));
        mUpperColors[4] = typedArray.getInt(R.styleable.CircleProgress_upperColor3, Color.parseColor("#C48E5E"));
        mUpperColors[5] = typedArray.getInt(R.styleable.CircleProgress_upperColor1, Color.parseColor("#ECC980"));
